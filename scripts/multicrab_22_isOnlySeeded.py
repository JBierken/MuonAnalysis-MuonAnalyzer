...
def getOptions():
    ...
    parser.add_option('-w', '--workArea',
                      dest = 'workArea',
                      default= 'crab_standAloneMuons_22_isOnlySeeded',
    ...
    parser.add_option('-e', '--era',
                      dest = 'era',
                      default = 'Run2022',
                      help = "Era to run samples over. Options are 'Run2022'/'Run2018'/'Run2017'/'Run2016'/'Run2018_UL'/'Run2017_UL'/'Run2016_UL'/'Run2016_UL_HIPM'. Default is 'Run2018'.",
                      metavar = 'ERA')
    ...
    parser.add_option('-f', '--configFile',
                      dest = 'configFile',
                      default = 'MuonAnalysis/MuonAnalyzer/test/run_muonAnalyzer_cfg_22_isOnlySeeded.py',
...
def main():
    ...
    if crabCmd == 'submit':
        ...
        if storageSite == 'FNAL':
            ...
            config.Data.outLFNDirBase           = '/store/group/phys_tracking/%s/FinalJetscrab_AOD_Run2022_pTFromTracker_isOnlySeeded/%s/%s/%s/%s' % (getUsername(), particle, resonance, era, dataTier)
        ...
        with open(sample_db, 'r') as db_file:
            ...
            try:
                ...
                if subEra == 'all':             samples = suberas
                else:                           samples = dict({subEra: suberas[subEra]})
            except:
        ...
        for subera_name, subera_cfg in samples.items():
            ...
            if 'lxplus' in hostname:            LM_prefix = '/afs/cern.ch/cms/CAF/CMSCOMM/COMM_DQM/certification/Collisions'
            else:                               LM_prefix = 'https://cms-service-dqmdc.web.cern.ch/CAF/certification/Collisions' 
             
            config.Data.lumiMask                = ''
            if isData:
                if 'UL' in era:
                    if '2018' in era:           config.Data.lumiMask = LM_prefix + '18/13TeV/Legacy_2018/Cert_314472-325175_13TeV_Legacy2018_Collisions18_JSON.txt'
                    elif '2017' in era:         config.Data.lumiMask = LM_prefix + '17/13TeV/Legacy_2017/Cert_294927-306462_13TeV_UL2017_Collisions17_GoldenJSON.txt'
                    elif '2016' in era:         config.Data.lumiMask = LM_prefix + '16/13TeV/Legacy_2016/Cert_271036-284044_13TeV_Legacy2016_Collisions16_JSON.txt'
                else:
                    if '2022' in era:           config.Data.lumiMask = 'https://cms-service-dqmdc.web.cern.ch/CAF/certification/Collisions22/Cert_Collisions2022_355100_362760_Golden.json'
                    if '2022EE' in era:         config.Data.lumiMask = 'https://cms-service-dqmdc.web.cern.ch/CAF/certification/Collisions22/Cert_Collisions2022_355100_362760_Golden.json'
                    if '2018' in era:           config.Data.lumiMask = LM_prefix + '18/13TeV/ReReco/Cert_314472-325175_13TeV_17SeptEarlyReReco2018ABC_PromptEraD_Collisions18_JSON.txt'
                    elif '2017' in era:         config.Data.lumiMask = LM_prefix + '17/13TeV/ReReco/Cert_294927-306462_13TeV_EOY2017ReReco_Collisions17_JSON_v1.txt'
                    elif '2016' in era:         config.Data.lumiMask = LM_prefix + '16/13TeV/ReReco/Cert_271036-284044_13TeV_ReReco_07Aug2017_Collisions16_JSON.txt'
