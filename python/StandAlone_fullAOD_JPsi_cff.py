...
muon = cms.EDAnalyzer('StandAloneMuonFullAODAnalyzer',
                      ...
                      trgDRwindow= cms.double(0.5), # dr winwow hlt mu/offline
                      tagQuality = cms.uint32(0),
                      tagSelection = cms.string("pt()>8"),
                      probeHPurity = cms.bool(False),
                      probeSelection = cms.string("pt()>3"), #--> What threshhold should I take??
                      probeSelectionSA = cms.string("pt()>3"),
                      muonOnly = cms.bool(True), # allow only reco or pat Muon for probes
                      probeMuonSelection = cms.string("pt()>3"), #string for probe (reco or pat Muon)
                      pairMassMin = cms.double(2.8),
                      pairMassMax = cms.double(3.5), # 9999.0 for high mass C&C
