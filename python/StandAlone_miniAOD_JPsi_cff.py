...
muon = cms.EDAnalyzer('StandAloneMuonMiniAODAnalyzer',
        ...
        #    l1MatchesByQDeltaR = cms.InputTag("muonL1InfoByQ", "deltaR"),
           ...
           tagSelection = cms.string("pt()>5"), # string to pass cuts on tag
           ProbeHPurity = cms.bool(False), # skips non High purity probes
           probeSelection = cms.string("pt()>2"), #string for probe
           probeSelectionSA = cms.string("pt()>2"), #string for probe
           ...
           pairMassMin = cms.double(2.8), # min mass of mu pair
           pairMassMax = cms.double(3.4), # max mss of mu pair (9999.0 for high mass C&C)
           ...
           minPtTrkSA=cms.double(0),  # min Pt for trk matching for SA muons
           maxDzProbeTrkSAMuon = cms.double(0.01), # max Dz(trk,SAmu)
